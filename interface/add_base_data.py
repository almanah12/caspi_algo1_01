...
class Add_Base_Data(QDialog):
    def __init__(self, parent: QMainWindow):
        ...
        self.mapper.addMapping(self.articul_lineEdit, 3)
        self.mapper.addMapping(self.lineEdit_2, 4)
        self.mapper.addMapping(self.check_limiter_comboBox, 5)
        self.mapper.addMapping(self.limiter_comboBox, 6)

        self.mapper.addMapping(self.current_price_lineEdit_1, 9)
        self.mapper.addMapping(self.first_cost_lineEdit_1, 10)
        self.mapper.addMapping(self.min_price_spinBox_1, 11)
        self.mapper.addMapping(self.min_price_lineEdit_1, 12)
        self.mapper.addMapping(self.max_price_spinBox_1, 13)
        self.mapper.addMapping(self.max_price_lineEdit_1, 14)

        self.mapper.addMapping(self.current_price_lineEdit_2, 17)
        self.mapper.addMapping(self.first_cost_lineEdit_2, 18)
        self.mapper.addMapping(self.min_price_spinBox_2, 19)
        self.mapper.addMapping(self.min_price_lineEdit_2, 20)
        self.mapper.addMapping(self.max_price_spinBox_2, 21)
        self.mapper.addMapping(self.max_price_lineEdit_2, 22)

        self.mapper.addMapping(self.current_price_lineEdit_3, 25)
        self.mapper.addMapping(self.first_cost_lineEdit_3, 26)
        self.mapper.addMapping(self.min_price_spinBox_3, 27)
        self.mapper.addMapping(self.min_price_lineEdit_3, 28)
        self.mapper.addMapping(self.max_price_spinBox_3, 29)
        self.mapper.addMapping(self.max_price_lineEdit_3, 30)

        self.mapper.addMapping(self.current_price_lineEdit_4, 33)
        self.mapper.addMapping(self.first_cost_lineEdit_4, 34)
        self.mapper.addMapping(self.min_price_spinBox_4, 35)
        self.mapper.addMapping(self.min_price_lineEdit_4, 36)
        self.mapper.addMapping(self.max_price_spinBox_4, 37)
        self.mapper.addMapping(self.max_price_lineEdit_4, 38)
